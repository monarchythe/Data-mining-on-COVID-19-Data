...
- For Part 2 : **Kmeans_PAM_GMM_and_ClusterEvaluation.R** and **Hierarchical_Clustering.R**
- For Part 3 : **KNN_and_Naive_Bays_classification.R** and **Tree_randomForest_logRegression.R**
